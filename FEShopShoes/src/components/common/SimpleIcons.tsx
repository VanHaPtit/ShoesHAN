...
export const CartIcon: React.FC<{ count?: number, className?: string }> = ({ count = 0, className = "w-6 h-6" }) => (
...
export const AdidasLogo: React.FC<{ className?: string }> = ({ className = "w-16 h-12" }) => (
  <svg className={className} viewBox="0 0 100 60" fill="currentColor">
    <path d="M15 50 L35 10 L55 50 Z" />
    <path d="M35 50 L55 25 L75 50 Z" />
    <path d="M55 50 L75 35 L95 50 Z" />
  </svg>
);
